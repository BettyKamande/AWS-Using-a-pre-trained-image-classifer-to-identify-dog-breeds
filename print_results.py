...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        if key.startswith("p"):
            print("All the percentages include: {},{}".format(key, results_stats_dic[key]))
    #prints out if print_incorrect_dogs = True
   ...
   #pet image is a dog, classifier label is a dog but it does not match hence wrong breed = incorrectly classified breeds
        for key, labels in results_dic.items():
